    ...
    <footer className="bg-white py-4 text-center absolute w-full bottom-0 mt-4">
      <div className="container mx-auto">
        <div className="mb-3.5">
          <img src="Facebook.png" alt="logoFacebook" className="h-5 inline-block mr-4" />
          <img src="Instagram.png" alt="logoInstagram" className="h-5 inline-block mr-4" />
          <img src="Whatsapp.png" alt="logowhatsapp" className="h-5 inline-block" />
        </div>
